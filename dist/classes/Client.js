...
var require_api = __commonJS({
  "src/api.js"(exports2, module2) {
    ...
    var api2 = (baseUrl, limiter) => new API({
      headers: {
...
var require_GroupManager = __commonJS({
  "src/classes/GroupManager.js"(exports2, module2) {
    var Collection = require_Collection();
    var Group = require_Group();
    var Manager = require_Manager();
    var GroupManager2 = class extends Manager {
      constructor(client) {
...
var require_MatchManager = __commonJS({
  "src/classes/MatchManager.js"(exports2, module2) {
    ...
    module2.exports = MatchManager2;
  }
});

// src/classes/TeamManager.js
var require_TeamManager = __commonJS({
  "src/classes/TeamManager.js"(exports2, module2) {
    var Team = require_Team();
    var Manager = require_Manager();
    var Collection = require_Collection();
    var TeamManager2 = class extends Manager {
      constructor(client) {
